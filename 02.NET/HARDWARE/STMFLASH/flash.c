...
void W_Test(void)
{
  ...
  System_WriteInteriorFlash(addrShort1, (uint8_t *)&device_state_init.apple_p, sizeof(device_state_init.apple_p)); // 存入数据，函数内自动解锁，擦除，写入
	System_WriteInteriorFlash(addrShort2, (uint8_t *)&device_state_init.banana_p, sizeof(device_state_init.banana_p)); // 存入数据，函数内自动解锁，擦除，写入
	System_WriteInteriorFlash(addrShort3, (uint8_t *)&device_state_init.orange_p, sizeof(device_state_init.orange_p)); // 存入数据，函数内自动解锁，擦除，写入

}
// 读取数据
void R_Test(void)
{
  System_ReadInteriorFlash(addrShort1, (uint8_t *)&device_state_init.apple_p, sizeof(device_state_init.apple_p)); // 读取数据，函数内自动按半字读取
  System_ReadInteriorFlash(addrShort2, (uint8_t *)&device_state_init.banana_p, sizeof(device_state_init.banana_p)); // 读取数据，函数内自动按半字读取
  System_ReadInteriorFlash(addrShort3, (uint8_t *)&device_state_init.orange_p, sizeof(device_state_init.orange_p)); // 读取数据，函数内自动按半字读取
